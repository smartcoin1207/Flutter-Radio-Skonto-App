...
const double _kDatePickerPadSize = 42.0;
...
class _CupertinoDatePickerMonthYearState extends State<CupertinoDatePicker> {
  ...
  void _refreshEstimatedColumnWidths() {
    estimatedColumnWidths[_PickerColumnType.month.index] =
        CustomCupertinoDatePicker._getColumnWidth(_PickerColumnType.month, localizations, context, false, standaloneMonth: widget.mode == CupertinoDatePickerMode.monthYear);
